...
freq_ranges = [(0, 0.01), (0.075, 0.085)]
gdmd_dict = []
...
for l_freq, r_freq in freq_ranges:
    filename = os.path.join(HOME, f"netmats/3T_HCP1200_MSMAll_d{N}_ts2/netmats3_{l_freq}_{r_freq}_dgdmd.txt")
...
np.savetxt(os.path.join(HOME, f"netmats/3T_HCP1200_MSMAll_d{N}_ts2/netmat3{suffix}_dgdmd.txt"), res)
